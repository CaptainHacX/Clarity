...
Thanks for your interest in contributing! Clarity is a community-driven project and we welcome all contributions — bug reports, feature requests, documentation improvements, and code.
...
Use the [bug report template](https://github.com/CaptainHacX/Clarity/issues/new?template=bug_report.md). Include your OS, Clarity version, and steps to reproduce.

## Suggesting Features

Use the [feature request template](https://github.com/CaptainHacX/Clarity/issues/new?template=feature_request.md).

...
We recommend always running the latest version of Clarity.

## Reporting a Vulnerability

If you discover a security vulnerability in Clarity, **please do not open a public issue.**

Instead, report it privately via [GitHub Security Advisories](https://github.com/CaptainHacX/Clarity/security/advisories/new).
...
This policy covers the Clarity desktop application and its source code. It does not cover third-party dependencies — please report those to the respective maintainers.

## Security Design

Clarity is a system cleaner that operates with elevated permissions. We take this responsibility seriously:

- **No telemetry** — Clarity does not phone home or collect any user data.

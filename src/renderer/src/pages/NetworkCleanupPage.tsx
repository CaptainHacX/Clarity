...
export function NetworkCleanupPage() {
  ...
  const handleScan = useCallback(async () => {
    ...
    try {
      const result = await window.clarity.networkScan()
  ...
  const handleClean = useCallback(async () => {
    ...
    try {
      ...
      const result = await window.clarity.networkClean([...currentSelectedIds])
      const s = useNetworkStore.getState()
      ...
      try {
        const freshItems = await window.clarity.networkScan()

...
export function DiskRepairPage() {
  ...
  useEffect(() => {
    if (!window.clarity?.onDiskRepairProgress) return
    return window.clarity.onDiskRepairProgress((data) => store.setRepairProgress(data))
  }, [])
  ...
  const handleRunSfc = async () => {
    ...
    try {
      const result = await window.clarity.diskRepairSfc('C')
  ...
  const handleRunDism = async () => {
    ...
    try {
      const result = await window.clarity.diskRepairDism()
  ...
  const handleRunChkdsk = async () => {
    ...
    try {
      const result = await window.clarity.diskRepairChkdsk('C')

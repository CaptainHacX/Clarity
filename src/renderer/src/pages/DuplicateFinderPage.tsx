...
export function DuplicateFinderPage() {
  ...
  useEffect(() => {
    if (!window.clarity?.onDuplicatesProgress) return
    return window.clarity.onDuplicatesProgress((data) => {
  ...
  const handleSelectDir = async () => {
    const dir = await window.clarity?.duplicatesSelectDir?.()
  ...
  const handleScan = async () => {
    ...
    try {
      const result = await window.clarity?.duplicatesScan?.({
  ...
  const handleCancel = async () => {
    await window.clarity?.duplicatesCancel?.()
  }
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const result = await window.clarity?.duplicatesDelete?.(paths, store.deleteMode)
      if (result) {
                            ...
                            return (
                              ...
                              >
                                ...
                                <button
                                  onClick={(e) => {
                                    e.stopPropagation()
                                    window.clarity?.duplicatesOpenLocation?.(file.path)
                                  }}

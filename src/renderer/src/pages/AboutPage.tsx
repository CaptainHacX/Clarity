    ...
    <div className="animate-fade-in">
      ...
      <div className="glass-card rounded-2xl p-6">
        <div className="flex items-center gap-4">
          <img src={logoSrc} alt="Clarity" className="h-14 w-14 rounded-xl" />
          <div>
        ...
        <div className="mt-5 flex items-center gap-3">
          {updateStatus.state === 'idle' && (
            <button
              onClick={() => window.clarity?.updaterCheck?.()}
          ...
          {updateStatus.state === 'available' && (
            <>
              ...
              <button
                onClick={() => window.clarity?.updaterDownload?.()}
          ...
          {updateStatus.state === 'downloaded' && (
            <button
              onClick={() => window.clarity?.updaterInstall?.()}
        ...
        <div className="mt-6 flex items-center gap-2.5">
          <LinkButton icon={Github} label={t('github')} href="https://github.com/CaptainHacX/Clarity" />
          <LinkButton icon={Bug} label={t('reportBug')} href="https://github.com/CaptainHacX/Clarity/issues" />
        </div>
      </div>
    </div>
  )

...
// See https://github.com/CaptainHacX/Clarity/issues/264.
...
describe('electron-builder.yml', () => {
  it('requests admin for the app executable', () => {
    // Clarity edits HKLM, system directories and other machine-wide state, so the
  ...
  it('installs per-machine whenever the app manifest requires admin', () => {
    // requestedExecutionLevel is applied to Clarity.exe only; the NSIS installer

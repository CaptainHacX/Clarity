...
import { loadBlacklist, loadSeedBlacklist } from './threat-blacklist-store'
import { logInfo, logError } from './logger'
import type { ThreatBlacklist, FlaggedConnection, FlaggedDnsEntry, ThreatSnapshot } from '../../shared/types'
...
class ThreatMonitorService {
  ...
  private loadAndBuildLookups(): void {
    this.blacklist = loadBlacklist() ?? loadSeedBlacklist()
    this.ipSet.clear()

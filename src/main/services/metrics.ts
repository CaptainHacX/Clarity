...
export async function collectMetrics(): Promise<MetricLine[]> {
  ...
  // System uptime
  metrics.push({
    name: 'clarity_system_uptime_seconds',
    type: 'gauge',
  ...
  try {
    ...
    metrics.push({
      name: 'clarity_system_cpu_usage_percent',
      type: 'gauge',
    ...
    metrics.push({
      name: 'clarity_system_memory_total_bytes',
      type: 'gauge',
    ...
    metrics.push({
      name: 'clarity_system_memory_used_bytes',
      type: 'gauge',
  ...
  metrics.push({
    name: 'clarity_items_cleaned_total',
    type: 'gauge',
  ...
  metrics.push({
    name: 'clarity_space_saved_bytes_total',
    type: 'gauge',
  ...
  metrics.push({
    name: 'clarity_scan_errors_total',
    type: 'gauge',
  ...
  if (history.length > 0) {
    ...
    metrics.push({
      name: 'clarity_last_scan_timestamp_seconds',
      type: 'gauge',
    ...
    metrics.push({
      name: 'clarity_last_scan_duration_seconds',
      type: 'gauge',
    ...
    metrics.push({
      name: 'clarity_last_scan_items_found',
      type: 'gauge',

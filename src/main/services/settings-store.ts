...
import type { ClaritySettings, ScheduleEntry, ScheduleTaskType, MalwareAllowlistEntry, WindowsPackageManager, WindowState } from '../../shared/types'
...
export function setSettings(partial: Partial<ClaritySettings>): void {

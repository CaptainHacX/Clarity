export const IPC = {
  ...
  NETWORK_SECURITY_SCAN: 'network-security:scan',
  /** Ask macOS to reveal WiFi details that are redacted because Location Services access is missing. */
  NETWORK_SECURITY_REQUEST_LOCATION: 'network-security:request-location',
  /** Open macOS Settings > Privacy & Security > Location Services. */
  NETWORK_SECURITY_OPEN_LOCATION_SETTINGS: 'network-security:open-location-settings',

  // Wi-Fi Scanner tool
  WIFI_SCAN: 'wifi:scan',
  WIFI_EXPORT: 'wifi:export',
  /** macOS Location Services state, inferred from whether CoreWLAN returns BSSIDs. */
  WIFI_LOCATION_STATUS: 'wifi:location-status',

  // Devices tool
  DEVICES_SCAN: 'devices:scan',
  DEVICES_LINK_QUALITY: 'devices:link-quality',
  DEVICES_PROBE_DEVICE: 'devices:probe-device',
  DEVICES_TAG_SET: 'devices:tag:set',
  DEVICES_TAG_CLEAR: 'devices:tag:clear',
  DEVICES_HISTORY_GET: 'devices:history:get',
  DEVICES_HISTORY_CLEAR: 'devices:history:clear',
  DEVICES_PORT_RESULTS_SET: 'devices:port-results:set',
  /** Read what a service announces about itself on an open port (opt-in, read-only). */
  DEVICES_INSPECT_SERVICE: 'devices:inspect-service',
  /** Open a device's own web interface in a viewer locked to that one device. */
  DEVICES_OPEN_WEB_VIEWER: 'devices:open-web-viewer',

  // Network Security tool
  SECURITY_SCAN_ALL: 'security:scan-all',
  SECURITY_SCAN_DEVICE: 'security:scan-device',
  SECURITY_RESULTS_GET: 'security:results:get',
  SECURITY_FULL_SCAN_START: 'security:full-scan:start',
  SECURITY_FULL_SCAN_STATUS: 'security:full-scan:status',
  SECURITY_FULL_SCAN_CANCEL: 'security:full-scan:cancel',
  SECURITY_SETTINGS_GET: 'security:settings:get',
  SECURITY_SETTINGS_SET: 'security:settings:set',
  SECURITY_CLEAR_RESULTS: 'security:results:clear',

  // System Health Report
  HEALTH_REPORT_GENERATE: 'health-report:generate',
  ...
  ALERT_CLEAR_HISTORY: 'alert:clear-history',

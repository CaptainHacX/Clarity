...
/**
 * GPT-5.4 Translation Script for Clarity i18n
 *
 * Usage:
...
- Keep brand names unchanged: Clarity, Windows, macOS, Linux, Chrome, Firefox, PowerShell, winget, Homebrew, Microsoft Store, GitHub, S.M.A.R.T., SFC, DISM, UAC, Defender, ClamAV, LLMNR, WPAD, SMBv1, RDP, Hyper-V, Xbox, Cortana, Copilot, Recall, DPAPI, Keychain
...
async function main() {
  ...
  console.log(`\nClarity i18n Translation Script`)
